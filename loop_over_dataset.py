...
show_only_frames = [121, 122] # show only frames in interval for debugging
...
exec_detection = ['pcl_from_rangeimage', 'load_image','bev_from_pcl', ] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
